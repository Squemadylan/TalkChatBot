...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string]$PromptFile = "e:\New\Dubaixia\user-prompts.txt",

    [Parameter(Mandatory = $false)]
    [string]$TodoFile = "e:\New\Dubaixia\backlog-todos.md",

    [Parameter(Mandatory = $false)]
    [string]$PrdOutputDir = "e:\New\Dubaixia\.ai\prd",

    [Parameter(Mandatory = $false)]
    [string]$LogFile = "e:\New\Dubaixia\task-manager.log",
...
function Invoke-AutoBuild {
    ...
    $buildScript = "e:\New\Dubaixia\Auto-Publish.ps1"
...
function Invoke-Iteration {
    ...
    $iterationScript = "e:\New\Dubaixia\Start-Iteration.ps1"
...
Write-Log "  - Write prompts to user-prompts.txt" "INFO"
